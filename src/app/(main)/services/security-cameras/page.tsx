        ...
        <div className="mx-auto max-w-6xl px-6">
          <FadeIn animation="fade-in-up" margin="0px">
            ...
            <p className="mt-4 max-w-2xl text-lg text-muted leading-relaxed">
              Camera systems with local AI detection powered by Frigate NVR. No cloud subscriptions,
              no monthly fees, no vendor lock-in. Just reliable surveillance that you own and
              control &mdash; affordable enough for any small business.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <FadeIn animation="fade-in-up">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-lg text-muted">
                I&apos;ll scope the install, recommend cameras that fit your space and budget, and
                have you up and running with local AI detection &mdash; no subscriptions, no
                surprises.
              </p>
