...
const jsonLd = {
  ...
  description:
    "Windows deployment, management, and application support for desktops and servers.",
  url: "https://tylervigario.com/services/windows",
  provider: {
        ...
        <div className="mx-auto max-w-6xl px-6">
          <FadeIn animation="fade-in-up" margin="0px">
            ...
            <p className="mt-4 max-w-2xl text-lg text-muted leading-relaxed">
              Deployment, management, and support for Windows desktops and
              servers. If it runs on Windows, I can set it up, fix it, and keep
              it running. Workstations, servers, Active Directory, Group
              Policy &mdash; the full stack.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <FadeIn animation="fade-in-up">
            <div className="mx-auto max-w-3xl">
              ...
              <div className="mt-6 space-y-4 text-muted leading-relaxed sm:text-lg">
                <p>
                  I don&apos;t do cookie-cutter deployments. Every setup starts
                  with understanding how your business actually uses its
                  computers &mdash; what apps you rely on, how your team works,
                  and what&apos;s been causing problems.
                </p>
                <p>
                  From there I build a system that fits: properly configured,
                  properly secured, and documented so you&apos;re not dependent on
                  anyone&apos;s memory of how things were set up. Whether it&apos;s
                  one workstation or a full server environment with Active
          ...
          <FadeIn animation="fade-in-up">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-lg text-muted">
                Whether it&apos;s a new deployment, an app that won&apos;t
                cooperate, or a server that needs attention &mdash; let&apos;s talk.
              </p>
