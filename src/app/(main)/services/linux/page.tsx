...
const jsonLd = {
  ...
  description: "Linux server deployment, configuration, and ongoing maintenance.",
  url: "https://tylervigario.com/services/linux",
  provider: {
        ...
        <div className="mx-auto max-w-6xl px-6">
          <FadeIn animation="fade-in-up" margin="0px">
            ...
            <p className="mt-4 max-w-2xl text-lg text-muted leading-relaxed">
              Server-side Linux deployment, configuration, and maintenance. Web servers, Docker
              hosts, networking appliances, storage &mdash; all CLI-driven, no unnecessary bloat.
              Built to run reliably and stay out of the way.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <FadeIn animation="fade-in-up">
            <div className="mx-auto max-w-3xl">
              ...
              <div className="mt-6 space-y-4 text-muted leading-relaxed sm:text-lg">
                <p>
                  Linux is what runs when nobody&apos;s watching &mdash; your web server, your NVR,
                  your Docker stack. I set these systems up to be stable, secure, and maintainable.
                  No GUI dependencies, no black-box configs. Everything is documented and
                  reproducible.
                </p>
                <p>
                  Whether you need a single web server deployed or a full self-hosted stack with
                  containers, reverse proxies, and automated backups, I&apos;ll build it right the
                  first time and make sure you can manage it going forward.
                </p>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn animation="fade-in-up">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-lg text-muted">
                From a simple web server to a full containerized stack &mdash; let&apos;s talk about
                what you need.
              </p>
