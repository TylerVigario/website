        ...
        <div className="mx-auto max-w-6xl px-6">
          <FadeIn animation="fade-in-up" margin="0px">
            ...
            <p className="mt-4 max-w-2xl text-lg text-muted leading-relaxed">
              From home routers to commercial wireless deployments &mdash; I
              design, build, and troubleshoot networks that actually work.
              Switching, routing, firewalls, VPNs, WiFi, cabling, and
          ...
          <FadeIn animation="fade-in-up">
            <div className="mx-auto max-w-3xl">
              ...
              <div className="mt-6 space-y-4 text-muted leading-relaxed sm:text-lg">
                <p>
                  Networking is the foundation everything else sits on. A bad
                  network makes every other system unreliable &mdash; cameras
                  drop, VoIP calls cut out, cloud apps crawl. I start with
                  understanding the layout, the traffic patterns, and the pain
                  points, then build a network that handles what you actually
                  need it to handle.
                </p>
                <p>
                  Every install is clean, labeled, and documented. I don&apos;t
                  leave a rats nest of cables behind a desk and call it done.
                  Whether it&apos;s a single access point or a multi-building
                  deployment with VLANs and managed switching, the standard
                  is the same.
                </p>
              </div>
            </div>
          ...
          <FadeIn animation="fade-in-up">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-lg text-muted">
                Slow WiFi, dead zones, unreliable connections, or a full
                buildout from scratch &mdash; let&apos;s figure it out.
              </p>
