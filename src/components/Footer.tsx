    ...
    <footer className="border-t border-border py-8 sm:py-12">
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-4 text-sm text-muted md:gap-6" aria-label="Footer navigation">
        ...
        <div className="mt-6 flex flex-col items-center gap-3 text-sm text-muted md:flex-row md:justify-center md:gap-6">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 text-[#333]" aria-hidden="true">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 py-3 transition-colors hover:text-foreground"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 text-[#EA4335]" aria-hidden="true">
