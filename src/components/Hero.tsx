        ...
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:gap-16">
          ...
          >
            ...
            <div className="mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:items-center sm:gap-4">
              <a
                href="#contact"
                className="flex items-center justify-center gap-2 rounded-xl bg-accent px-6 py-3 text-base font-semibold text-white transition-all sm:px-8 sm:py-4 sm:text-lg hover:bg-accent-bright hover:shadow-lg hover:shadow-accent/15"
              >
                Get a free quote
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 rounded-xl border border-border px-6 py-3 text-base font-medium text-foreground transition-colors sm:px-8 sm:py-4 sm:text-lg hover:border-accent/30 hover:bg-surface"
              >
