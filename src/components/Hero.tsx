        ...
        <FadeIn animation="fade-in-up" margin="0px">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-4xl font-bold leading-tight tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
              Your IT shop that <span className="text-accent-bright">actually picks up</span>
            </h1>

            <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/70 sm:text-lg sm:mt-8">
              From pulling cable to writing custom software, I handle the full stack for small
              businesses in the Central Valley. No ticket queues, no runaround &mdash; just 20+
              years of hands-on experience and a direct line.
            </p>
            ...
            {stats.map((s, i) => (
              <div key={s.label} className="flex items-center gap-x-12">
                ...
                <div className="text-center">
                  <div className="text-xl font-bold text-accent-bright sm:text-2xl">{s.value}</div>
